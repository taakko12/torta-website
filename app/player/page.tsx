...
export default function PlayerSearchPage() {
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-20">
      ...
      <p className="text-sm text-[#9898c0] text-center mb-8">Search by in-game username</p>
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          className="flex-1 rounded-lg bg-[#1c1c36] border border-[#333358] px-4 py-2.5 text-[#e8e8f0] placeholder-[#9898c0] focus:outline-none focus:border-[#c89b3c]"
        />
        <button
          type="submit"
