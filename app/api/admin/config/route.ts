...
const ALLOWED = ['planks_channel_id', 'drops_channel_id', 'lootsubmit_channel_id', 'welcome_channel_id', 'welcome_mod_channel_id', 'welcome_role_id', 'clanchat_channel_id', 'broadcast_channel_id', 'inactivity_channel_id', 'recap_channel_id']
